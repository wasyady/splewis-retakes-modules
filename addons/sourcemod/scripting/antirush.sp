...
#define PREFIX "[\x05SourceTurk\x01] \x04"
...
{
	new Handle:hVersion = CreateConVar("sm_antirush_version", PLUGIN_VERSION, "Anti Rush Version", 0|FCVAR_NOTIFY|FCVAR_REPLICATED|FCVAR_DONTRECORD);
	...
	g_hCVNoRushTime = CreateConVar("sm_antirush_norushtime", "13.0", "Time in seconds rushing is not allowed after round start?", 0, true, 0.0, true, 530.0);
	...
	g_hCVShowZones = CreateConVar("sm_antirush_showzones", "0", "Show the zones either when rushing is not allowed?", 0, true, 0.0, true, 1.0);
